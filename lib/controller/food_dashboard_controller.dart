...
import 'package:webui/models/food_data.dart';
...
class FoodDashboardController extends MyController {
  ...
  List<RadialBarSeries<ChartSampleData, String>> getRadialBarSeries() {
    final List<ChartSampleData> chartData = <ChartSampleData>[
      ChartSampleData(x: 'Food', y: 25, text: 'Food  ', xValue: null, pointColor: const Color.fromRGBO(0, 201, 230, 1.0)),
      ChartSampleData(x: 'Drink', y: 43, text: 'Drink  ', xValue: null, pointColor: const Color.fromRGBO(63, 224, 0, 1.0)),
      ChartSampleData(x: 'Other', y: 58, text: 'other  ', xValue: null, pointColor: const Color.fromRGBO(226, 1, 26, 1.0)),
    ];
