...
class FlChartController extends MyController {
  ...
  LineTouchData get lineTouchData1 => LineTouchData(handleBuiltInTouches: true, touchTooltipData: LineTouchTooltipData());
  ...
  LineChartBarData get lineChartBarData1_1 => LineChartBarData(
    ...
    spots: const [FlSpot(1, 1), FlSpot(3, 1.5), FlSpot(5, 1.4), FlSpot(7, 3.4), FlSpot(10, 2), FlSpot(12, 2.2), FlSpot(13, 1.8)],
  );
    ...
    return LineChartData(
      ...
      lineBarsData: [
        LineChartBarData(
          ...
          isStrokeCapRound: true,
          dotData: const FlDotData(show: false),
          belowBarData: BarAreaData(show: true, gradient: LinearGradient(colors: gradientColors.map((color) => color.withValues(alpha: 0.3)).toList())),
        ),
      ],
    );
  }
  ...
  BarTouchData get barTouchData => BarTouchData(
    ...
    touchTooltipData: BarTouchTooltipData(
      ...
      getTooltipItem: (BarChartGroupData group, int groupIndex, BarChartRodData rod, int rodIndex) {
        return BarTooltipItem(rod.toY.round().toString(), const TextStyle(color: Colors.cyan, fontWeight: FontWeight.bold));
      },
    ),
  );
  ...
  LinearGradient get _barsGradient =>
      LinearGradient(colors: [Colors.blue.shade300, Colors.cyan], begin: Alignment.bottomCenter, end: Alignment.topCenter);
  ...
  BarChartGroupData generateGroupData(int x, double pilates, double quickWorkout, double cycling) {
    return BarChartGroupData(
      ...
      barRods: [
        ...
        BarChartRodData(fromY: pilates + betweenSpace, toY: pilates + betweenSpace + quickWorkout, color: Colors.blue, width: 5),
        BarChartRodData(
